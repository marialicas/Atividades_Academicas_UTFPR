...
ListaE *Intercalada(ListaE *lista1, ListaE *lista2) {
  ListaE *listaIntercalada = criar_listaE();
  Cell *atual1 = lista1->head, *atual2 = lista2->head;

  if (tamanho_LE(lista2) > tamanho_LE(lista1)) {
    while (atual2 != NULL) {
      if (atual1 != NULL) {
        inserir_ultimo(atual1->item, listaIntercalada);
        atual1 = atual1->proximo;
      }
      inserir_ultimo(atual2->item, listaIntercalada);
...
int main() {
  ListaE *lista1, *lista2, *listaIntercalada;
  lista1 = criar_listaE();
  lista2 = criar_listaE();
  listaIntercalada = criar_listaE();
  ...
  listaIntercalada = Intercalada(lista1, lista2);

  imprimir(listaIntercalada);
